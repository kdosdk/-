...
const data = {
  ...
  formatTime: function() {
    ...
    if ([20, 50].includes(this.minutes)) {
      console.log("站起来活动一下吧！"); // 在控制台输出提示信息
      // 如果需要在页面上显示，可以使用以下代码替换上面的console.log
      // document.getElementById('activity-reminder').textContent = "站起来活动一下吧！";
    }
